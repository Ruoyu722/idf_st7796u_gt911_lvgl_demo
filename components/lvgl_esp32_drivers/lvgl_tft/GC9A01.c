...
// void GC9A01_LCD_Fill(uint16_t xsta,uint16_t ysta,uint16_t xend,uint16_t yend,uint16_t color)
// {          
// 	uint8_t data[4];
// 	uint16_t i,j; 
// 	GC9A01_send_cmd(0x2A);				//0x2A
